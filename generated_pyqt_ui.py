...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.classifyProgressBar = QtWidgets.QProgressBar(self.centralwidget)
        self.classifyProgressBar.setEnabled(True)
        self.classifyProgressBar.setGeometry(QtCore.QRect(330, 290, 101, 31))
        self.classifyProgressBar.setMaximum(10)
        self.classifyProgressBar.setProperty("value", 0)
        self.classifyProgressBar.setObjectName("classifyProgressBar")
